...
clube_campeao <- c(1, 1, 1, 2, 1, 1, 2, 3, 2, 4, 3) #Campoôes pernambucanos desde 2011
...
divisao <- c(4, 3, 3, 1, 2, 1, 1, 3, 2, 4, 2) #divisão em que os clubes campe~ioes estavam quando consquistaram os respectivos títulos
